...
from src.profiler.model.alerts import get_alerts
from src.profiler.model.correlations import (
    calculate_correlation,
    get_active_correlations,
)
from src.profiler.model.dataframe import check_dataframe, preprocess
from src.profiler.model.duplicates import get_duplicates
from src.profiler.model.missing import get_missing_active, get_missing_diagram
from src.profiler.model.pairwise import get_scatter_plot, get_scatter_tasks
from src.profiler.model.sample import get_custom_sample, get_sample
from src.profiler.model.summarizer import BaseSummarizer
from src.profiler.model.summary import get_series_descriptions
from src.profiler.model.table import get_table_stats
from src.profiler.utils.progress_bar import progress
from src.profiler.version import __version__
...
def describe(
    ...
    if df is None:
        raise ValueError("Can not describe a ProfileReport without a DataFrame.")
